          ...
          <div class="card">
            <div class="content">
              <div id="newlog">
                ...
                <div class="title01">
                  <?= $configuration['app_theme'] == 'white' ? '<img src="'. base_url() .'assets/img/logo-hubii.png">' : '<img src="'. base_url() .'assets/img/logo-hubii-branco.png">'; ?>
                </div>
              </div>
              ...
              <div class="links-uteis"><a href=""><p><?= date('Y'); ?> &copy; NOME DO CRIADOR</p></a>
              </div>
        ...
        submitHandler: function(form) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data.result == true) {
                                window.location.href = "<?= site_url('painel'); ?>";
                            } else {
